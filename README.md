...
## Acknowledgements
* Portions of the code for the Bayesian method were inspired by/adapted from the implementation by Selma Metzner (PTB), 2021. [https://gitlab1.ptb.de/selmametzner/bayesian-uncertainty-quantification-for-magentic-resonance-fingerprinting]