...
function [] = save_t1_img(t1map, save_path, img_title, t1_range, mask, fontsize)
if nargin < 3
    img_title = '';
end
close all
...
figure;
[imClip, cmap] = plot_t1(t1map, t1min, t1max, fontsize);
title(img_title);
...
function [imClip, rgb_vec] = plot_t1(t2map, loLev, upLev, fontsize)
